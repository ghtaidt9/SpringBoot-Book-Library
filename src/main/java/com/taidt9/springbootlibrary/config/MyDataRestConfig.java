...
import com.taidt9.springbootlibrary.entity.Message;
import com.taidt9.springbootlibrary.entity.Review;
...
public class MyDataRestConfig implements RepositoryRestConfigurer {
    ...
    public void configureRepositoryRestConfiguration(RepositoryRestConfiguration config, CorsRegistry cors) {
        HttpMethod[] theUnsupportedActions = {HttpMethod.PUT, HttpMethod.PATCH, HttpMethod.DELETE, HttpMethod.POST};
